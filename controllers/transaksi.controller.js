...
// create export func to add transaksi
exports.addTransaksi = async (request, response) => {
    try {
        // execute data to add in transaksi
        let newTransaksi = {
        ...
        // assume thaht arrDetail is array type

        // loop each array detail to insert last ID and harga
        ...
        // execute isert detail transaksi using model
        await detailModel.bulkCreate(arrDetail)
        // bulkCreate = create dlm jumlh guuueeeddii
...
exports.deleteTransaksi = async (request, response) => {
    try {
        ...
        return response.json({
            status: true,
            message: `Data transaksi telah dihapus lebur`
        })
    } catch (error) {
        return response.json({
            status: false,
